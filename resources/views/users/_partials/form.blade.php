<div class="w-full bg-white shadow-md rounded px-8 py-12">
    ...
    <button type="submit" class="w-full shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-3 px-6 rounded">
        Enviar
    </button>
</div>
